...
func render(
	...
	sdkType, sdkLookup := "ui."+doc.SDKStruct, doc.SDKStruct
	if s.section != "" {
		name := camelNaive(s.section)
		sdkType, sdkLookup = "settings."+name, "settings."+name
	}
	...
	built := s.built(ctx)
	fields, err := deriveFields(built, doc, members, ui.FieldConstraints[strings.TrimPrefix(sdkLookup, "settings.")], hand)
	if err != nil {
		return nil, err
	}
	...
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by cmd/descriptor-emitter. DO NOT EDIT.\n\npackage unifi\n\n")
