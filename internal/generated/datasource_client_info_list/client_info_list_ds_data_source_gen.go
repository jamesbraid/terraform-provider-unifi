...
package datasource_client_info_list
...
func ClientInfoListDsDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"clients": schema.ListNestedAttribute{
				...
				Computed:            true,
				Description:         "List of active clients on the network.",
...
type ClientInfoListDsModel struct {
...
func (t ClientsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	lastUplinkRemotePortAttribute, ok := attributes["last_uplink_remote_port"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`last_uplink_remote_port is missing from object`)

		return nil, diags
	}

	lastUplinkRemotePortVal, ok := lastUplinkRemotePortAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`last_uplink_remote_port expected to be basetypes.Int64Value, was: %T`, lastUplinkRemotePortAttribute))
	}
	...
	uptimeVal, ok := uptimeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`uptime expected to be basetypes.StringValue, was: %T`, uptimeAttribute))
	}
	...
	return ClientsValue{
		...
		LastUplinkRemotePort:      lastUplinkRemotePortVal,
...
type ClientsValue struct {
	...
	LastUplinkRemotePort      basetypes.Int64Value  `tfsdk:"last_uplink_remote_port"`
...
func (v ClientsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["last_uplink_remote_port"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	attrTypes["uptime"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.LastUplinkRemotePort.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["last_uplink_remote_port"] = val
...
func (v ClientsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"last_uplink_remote_port":      basetypes.Int64Type{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"last_uplink_remote_port":      v.LastUplinkRemotePort,
...
func (v ClientsValue) Equal(o attr.Value) bool {
	...
	if !v.LastUplinkRemotePort.Equal(other.LastUplinkRemotePort) {
		return false
	}
