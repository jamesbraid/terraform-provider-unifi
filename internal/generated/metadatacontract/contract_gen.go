...
//
// A row here is a promise to practitioners: rename a surface and the driver
// in unifi/ reports it by receiver name. Regenerating this file is how that
// promise is deliberately broken, which is the point -- it makes a rename a
// visible diff in a frozen contract rather than an edit to one line of Go.
...
var FrozenTypeNames = map[string]string{
	...
	"firewallGroupResource":        "unifi_firewall_group",
	...
	"staticRouteFrameworkResource": "unifi_static_route",
