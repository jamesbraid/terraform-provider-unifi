...
// Every compile reads the behaviour artifact through this alias, so a writes
// entry gaining coverage of a compiled surface takes effect without anyone
// remembering a flag.
//go:generate -command speccompile go run ../cmd/provider-spec-compiler -behavior bootstrap/behavior.json
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dns-record.json -policy policy/dns_record.json -artifact-prefix dns_record -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-policy.json -policy policy/firewall_policy.json -artifact-prefix firewall_policy -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-power-supervisor.json -policy policy/power_supervisor.json -artifact-prefix power_supervisor -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-zone.json -policy policy/firewall_zone.json -artifact-prefix firewall_zone -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wlan.json -policy policy/wlan.json -artifact-prefix wlan -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-site.json -policy policy/site.json -artifact-prefix site -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-ap-group.json -policy policy/ap_group.json -artifact-prefix ap_group -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-group.json -policy policy/firewall_group.json -artifact-prefix firewall_group -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-qos-rate.json -policy policy/client_qos_rate.json -artifact-prefix client_qos_rate -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wireguard-peer.json -policy policy/wireguard_peer.json -artifact-prefix wireguard_peer -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dynamic-dns.json -policy policy/dynamic_dns.json -artifact-prefix dynamic_dns -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-user.json -policy policy/radius_user.json -artifact-prefix radius_user -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-bgp.json -policy policy/bgp.json -artifact-prefix bgp -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-static-route.json -policy policy/static_route.json -artifact-prefix static_route -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-profile.json -policy policy/radius_profile.json -artifact-prefix radius_profile -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-rule.json -policy policy/firewall_rule.json -artifact-prefix firewall_rule -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port-profile.json -policy policy/port_profile.json -artifact-prefix port_profile -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-site-to-site-vpn.json -policy policy/site_to_site_vpn.json -artifact-prefix site_to_site_vpn -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wan.json -policy policy/wan.json -artifact-prefix wan -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-ap-group-ds.json -policy policy/ap_group_ds.json -artifact-prefix ap_group_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-zone.json -policy policy/firewall_zone_list.json -artifact-prefix firewall_zone_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-ds.json -policy policy/client_ds.json -artifact-prefix client_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client.json -policy policy/client.json -artifact-prefix client -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-network-ds.json -policy policy/network_ds.json -artifact-prefix network_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-network.json -policy policy/network.json -artifact-prefix network -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-traffic-route.json -policy policy/traffic_route.json -artifact-prefix traffic_route -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-vpn-server.json -policy policy/vpn_server.json -artifact-prefix vpn_server -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-vpn-client.json -policy policy/vpn_client.json -artifact-prefix vpn_client -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port-forward.json -policy policy/port_forward.json -artifact-prefix port_forward -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-device.json -policy policy/device.json -artifact-prefix device -output-dir generated
...
//go:generate sdkbootstrap -package github.com/ubiquiti-community/go-unifi/unifi/settings -struct Usg -struct Rsyslogd -struct Ips -struct Lcm -struct Radius -struct Doh -struct Dpi -struct Mgmt -struct Ntp -struct Country -struct AutoSpeedtest -struct IgmpSnooping -struct NetworkOptimization -struct IpsSuppression -struct SettingUsgGeoIPFiltering -struct Locale -struct GlobalNat -struct SslInspection -struct Ipsec -struct Dashboard -struct EtherLighting -struct GlobalNetwork -struct TrafficFlow -struct Mdns -struct Teleport -struct MagicSiteToSiteVpn -struct GlobalSwitch -struct Netflow -struct RadioAi -struct Snmp -struct GuestAccess -struct Usw -struct GlobalAp -struct Connectivity -struct DeviceSupervision -resource unifi_setting -output bootstrap/go-unifi-v1.103.0-setting.json
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-setting.json -policy policy/setting.json -artifact-prefix setting -output-dir generated -emit-grouping-mappings
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-ap-group.json -policy policy/ap_group_list.json -artifact-prefix ap_group_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-list.json -policy policy/client_list.json -artifact-prefix client_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-qos-rate.json -policy policy/client_qos_rate_list.json -artifact-prefix client_qos_rate_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-device.json -policy policy/device_list.json -artifact-prefix device_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dynamic-dns.json -policy policy/dynamic_dns_list.json -artifact-prefix dynamic_dns_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-group.json -policy policy/firewall_group_list.json -artifact-prefix firewall_group_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-policy.json -policy policy/firewall_policy_list.json -artifact-prefix firewall_policy_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-rule.json -policy policy/firewall_rule_list.json -artifact-prefix firewall_rule_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-network.json -policy policy/network_list.json -artifact-prefix network_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port-forward.json -policy policy/port_forward_list.json -artifact-prefix port_forward_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port-profile.json -policy policy/port_profile_list.json -artifact-prefix port_profile_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-power-supervisor.json -policy policy/power_supervisor_list.json -artifact-prefix power_supervisor_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-profile.json -policy policy/radius_profile_list.json -artifact-prefix radius_profile_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-user.json -policy policy/radius_user_list.json -artifact-prefix radius_user_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-site.json -policy policy/site_list.json -artifact-prefix site_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-site-to-site-vpn.json -policy policy/site_to_site_vpn_list.json -artifact-prefix site_to_site_vpn_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-static-route.json -policy policy/static_route_list.json -artifact-prefix static_route_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-traffic-route.json -policy policy/traffic_route_list.json -artifact-prefix traffic_route_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-vpn-client.json -policy policy/vpn_client_list.json -artifact-prefix vpn_client_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-vpn-server.json -policy policy/vpn_server_list.json -artifact-prefix vpn_server_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wan.json -policy policy/wan_list.json -artifact-prefix wan_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wireguard-peer.json -policy policy/wireguard_peer_list.json -artifact-prefix wireguard_peer_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wlan.json -policy policy/wlan_list.json -artifact-prefix wlan_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port.json -policy policy/port_action.json -artifact-prefix port_action -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dns-record.json -policy policy/dns_record_list.json -artifact-prefix dns_record_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-firewall-zone-ds.json -policy policy/firewall_zone_ds.json -artifact-prefix firewall_zone_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-user-ds.json -policy policy/radius_user_ds.json -artifact-prefix radius_user_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-qos-rate-ds.json -policy policy/client_qos_rate_ds.json -artifact-prefix client_qos_rate_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dns-record-ds.json -policy policy/dns_record_ds.json -artifact-prefix dns_record_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-port-profile-ds.json -policy policy/port_profile_ds.json -artifact-prefix port_profile_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-radius-profile-ds.json -policy policy/radius_profile_ds.json -artifact-prefix radius_profile_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-list-ds.json -policy policy/client_list_ds.json -artifact-prefix client_list_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-info-list-ds.json -policy policy/client_info_list_ds.json -artifact-prefix client_info_list_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-client-info-ds.json -policy policy/client_info_ds.json -artifact-prefix client_info_ds -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wlan-group.json -policy policy/wlan_group.json -artifact-prefix wlan_group -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-wlan-group.json -policy policy/wlan_group_list.json -artifact-prefix wlan_group_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dhcp-option.json -policy policy/dhcp_option.json -artifact-prefix dhcp_option -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dhcp-option.json -policy policy/dhcp_option_list.json -artifact-prefix dhcp_option_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-schedule-task.json -policy policy/schedule_task.json -artifact-prefix schedule_task -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-schedule-task.json -policy policy/schedule_task_list.json -artifact-prefix schedule_task_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dpi-app.json -policy policy/dpi_app.json -artifact-prefix dpi_app -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dpi-app.json -policy policy/dpi_app_list.json -artifact-prefix dpi_app_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dpi-group.json -policy policy/dpi_group.json -artifact-prefix dpi_group -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-dpi-group.json -policy policy/dpi_group_list.json -artifact-prefix dpi_group_list -output-dir generated
...
//go:generate speccompile -bootstrap bootstrap/go-unifi-v1.103.0-hotspot-op.json -policy policy/hotspot_op.json -artifact-prefix hotspot_op -output-dir generated
