...
//
// protocol is set explicitly: the behaviour artifact records it required on
// create, so the compiler serves it as a required attribute and a config that
// omits it does not validate.
