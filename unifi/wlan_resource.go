...
// CRUD, both mappers and the plan-to-state copier are gone -- the kit does all
// four. What stays is what the kit has no opinion about: the schema graft, the
// state upgrader and the enhanced-IoT plan modifier.
