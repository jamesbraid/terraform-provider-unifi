...
func (r *apGroupKitResource) Schema(
	...
	// The released schema describes this surface in plain text, and a generated
	// schema always carries a MarkdownDescription, which makes description_kind
	// markdown for the block and every attribute. That is practitioner-visible
	// and the baseline is authoritative, so it is stripped rather than licensed
	// as a change. Same call and same reason as port_profile.
