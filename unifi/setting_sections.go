...
//
// usw and global_ap are new too, not migrated -- each exposed straight
// from the controller's own Usw/GlobalAp definition; see
// setting_usw_descriptor.go and setting_global_ap_descriptor.go.
