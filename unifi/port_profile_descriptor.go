...
func portProfileKitSpec() resourcekit.Spec[ppModel, ppSDK] {
	return resourcekit.Spec[ppModel, ppSDK]{
		...
		Fields: []resourcekit.Field[ppModel, ppSDK]{
			...
			ppInt("egress_rate_limit_kbps", func(m *ppModel) *types.Int64 { return &m.EgressRateLimitKbps },
				func(s *ppSDK) **int64 { return &s.EgressRateLimitKbps }),
			ppBool("egress_rate_limit_kbps_enabled", func(m *ppModel) *types.Bool { return &m.EgressRateLimitKbpsEnabled },
			...
			ppBool("lldpmed_notify_enabled", func(m *ppModel) *types.Bool { return &m.LLDPMedNotifyEnabled },
				func(s *ppSDK) *bool { return &s.LldpmedNotifyEnabled }),
			ppString("native_networkconf_id", func(m *ppModel) *types.String { return &m.NativeNetworkConfID },
				func(s *ppSDK) *string { return &s.NATiveNetworkID }, resourcekit.KeepZero),
			...
			ppBool("port_security_enabled", func(m *ppModel) *types.Bool { return &m.PortSecurityEnabled },
			...
			ppInt("priority_queue1_level", func(m *ppModel) *types.Int64 { return &m.PriorityQueue1Level },
				func(s *ppSDK) **int64 { return &s.PriorityQueue1Level }),
			ppInt("priority_queue2_level", func(m *ppModel) *types.Int64 { return &m.PriorityQueue2Level },
				func(s *ppSDK) **int64 { return &s.PriorityQueue2Level }),
			ppInt("priority_queue3_level", func(m *ppModel) *types.Int64 { return &m.PriorityQueue3Level },
				func(s *ppSDK) **int64 { return &s.PriorityQueue3Level }),
			ppInt("priority_queue4_level", func(m *ppModel) *types.Int64 { return &m.PriorityQueue4Level },
			...
			ppBool("stormctrl_bcast_enabled", func(m *ppModel) *types.Bool { return &m.StormctrlBcastEnabled },
				func(s *ppSDK) *bool { return &s.StormctrlBroadcastastEnabled }),
			ppInt("stormctrl_bcast_level", func(m *ppModel) *types.Int64 { return &m.StormctrlBcastLevel },
				func(s *ppSDK) **int64 { return &s.StormctrlBroadcastastLevel }),
			ppInt("stormctrl_bcast_rate", func(m *ppModel) *types.Int64 { return &m.StormctrlBcastRate },
				func(s *ppSDK) **int64 { return &s.StormctrlBroadcastastRate }),
			ppBool("stormctrl_mcast_enabled", func(m *ppModel) *types.Bool { return &m.StormctrlMcastEnabled },
				func(s *ppSDK) *bool { return &s.StormctrlMcastEnabled }),
			ppInt("stormctrl_mcast_level", func(m *ppModel) *types.Int64 { return &m.StormctrlMcastLevel },
				func(s *ppSDK) **int64 { return &s.StormctrlMcastLevel }),
			ppInt("stormctrl_mcast_rate", func(m *ppModel) *types.Int64 { return &m.StormctrlMcastRate },
			...
			ppBool("stormctrl_ucast_enabled", func(m *ppModel) *types.Bool { return &m.StormctrlUcastEnabled },
				func(s *ppSDK) *bool { return &s.StormctrlUcastEnabled }),
			ppInt("stormctrl_ucast_level", func(m *ppModel) *types.Int64 { return &m.StormctrlUcastLevel },
				func(s *ppSDK) **int64 { return &s.StormctrlUcastLevel }),
			ppInt("stormctrl_ucast_rate", func(m *ppModel) *types.Int64 { return &m.StormctrlUcastRate },
			...
			ppString("voice_networkconf_id", func(m *ppModel) *types.String { return &m.VoiceNetworkConfID },
				func(s *ppSDK) *string { return &s.VoiceNetworkID }, resourcekit.NullZero),
			resourcekit.StringSetField[ppModel, ppSDK]{
			...
			ppString("tagged_vlan_mgmt", func(m *ppModel) *types.String { return &m.TaggedVLANMgmt },
				func(s *ppSDK) *string { return &s.TaggedVLANMgmt }, resourcekit.NullZero),
			ppString("fec_mode", func(m *ppModel) *types.String { return &m.FecMode },
				func(s *ppSDK) *string { return &s.FecMode }, resourcekit.NullZero),
			ppString("setting_preference", func(m *ppModel) *types.String { return &m.SettingPreference },
				func(s *ppSDK) *string { return &s.SettingPreference }, resourcekit.NullZero),
			ppBool("port_keepalive_enabled", func(m *ppModel) *types.Bool { return &m.PortKeepaliveEnabled },
